...
function CheckIcon() {
  return <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" /></svg>
}
    ...
    <div className="min-h-[82svh] bg-[linear-gradient(180deg,#f8fffe_0%,#ffffff_32%,#ffffff_100%)] px-4 py-12 md:py-16">
      <div className="page-wrap-xs">
        ...
        <div className="space-y-3">
          {token && (
            <Link to={`/acompanhar/${token}`} className="btn-primary-lg w-full flex justify-center">
          ...
          <Link to="/medicamentos" className="btn-secondary-lg w-full flex justify-center">
            Fazer outro pedido
          </Link>
        </div>
      </div>
